...
INTENT_TEMPLATES: Dict[str, List[str]] = {
    ...
    "volume_down": [
        ...
        "lower the volume", "sound down", "make it quiet", "volume decrese"
    ],
    "media_play_pause": [
        "play", "pause", "resume playback", "stop playback", "stop music", "stop the music",
        "play music", "play the music" , "toggle music", "resume music", "pause playback"
    ],
    "media_next": [
    ...
    "next_workspace": [
        "next workspace", "go to next workspace", "switch to next workspace" ,"next work"
    ],
    "prev_workspace": [
        "previous workspace", "go to previous workspace", "prev workspace" ,"go back", 
    ],
    "toggle_fullscreen": [
...
class SimilarityMatcher:
    ...
    def __init__(self, threshold: float = 0.5):
        ...
        self.model = None  # Force None to completely bypass AI transformer downloads
        ...
        # Removed the background threading downloader to stop Hugging Face API checks completely.
        logger.info("Friday pure-procedural semantic matcher loaded successfully (100% Offline).")
